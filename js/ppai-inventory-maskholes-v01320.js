...
async function buildTemplateData(){
  ...
  // TRUE FALLBACK TEMPLATE: one solid, filled three-plaque silhouette made from
  // the known-good real snapshot. Emoji interiors, bronze rims and overlap seams
  // are deliberately NOT part of the template evidence.
  const silhouetteImg=await loadImage("images/inventory_cluster_solid_silhouette_v01320.png?v=01320");
